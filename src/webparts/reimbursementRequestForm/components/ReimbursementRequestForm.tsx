...
export default class ReimbursementRequestForm extends React.Component<IReimbursementRequestFormProps> {
  public render(): React.ReactElement<IReimbursementRequestFormProps> {
    ...
    return (
      <section className={`${styles.reimbursementRequestForm} ${hasTeamsContext ? styles.teams : ''}`}>
