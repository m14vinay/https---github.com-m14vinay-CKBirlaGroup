...
export default class ReimbursementRequestFormWebPart extends BaseClientSideWebPart<IReimbursementRequestFormWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IReimbursementRequestFormProps> = React.createElement(
