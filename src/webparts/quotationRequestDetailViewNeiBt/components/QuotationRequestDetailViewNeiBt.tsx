...
export default class QuotationRequestDetailViewNeiBt extends React.Component<IQuotationRequestDetailViewNeiBtProps> {
  public render(): React.ReactElement<IQuotationRequestDetailViewNeiBtProps> {
    ...
    return (
      <section className={`${styles.quotationRequestDetailViewNeiBt} ${hasTeamsContext ? styles.teams : ''}`}>
