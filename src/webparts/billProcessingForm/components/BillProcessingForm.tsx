...
export default class BillProcessingForm extends React.Component<IBillProcessingFormProps> {
  public render(): React.ReactElement<IBillProcessingFormProps> {
    ...
    return (
      <section className={`${styles.billProcessingForm} ${hasTeamsContext ? styles.teams : ''}`}>
