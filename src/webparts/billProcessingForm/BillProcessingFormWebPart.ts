...
export default class BillProcessingFormWebPart extends BaseClientSideWebPart<IBillProcessingFormWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IBillProcessingFormProps> = React.createElement(
      BillProcessingForm,
      {
