...
import type { IBillProcessingApprovalProps } from './IBillProcessingApprovalProps';
...
export default class BillProcessingApproval extends React.Component<IBillProcessingApprovalProps, IState> {

  constructor(props: IBillProcessingApprovalProps) {
    super(props);
...
private handleRequestNoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
 ...
 // optional
  ...
  private handlehold  = () => {
    console.log("Form hold:", this.state);
    alert("Form Hold");
  };
private handleReject = () => {
    console.log("Form Rejected:", this.state);
    alert("Form Rejected");
  };
  private handlePaid = () => {
    console.log("Form Paid:", this.state);
    alert("Paid Action Triggered");
  };

  public render(): React.ReactElement<IBillProcessingApprovalProps> {
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.leftPanel}>
          <h2>Bill Processing Approval</h2>
          <h4>Bill Processing / Request Approval</h4>
          ...
          <input name="ApproverComment" value={this.state.ApproverComment}   >
          </input>       

          {/* Buttons */}
          <div className={styles.buttonGroup}>
            <button className={styles.submitBtn} onClick={this.handleSubmit}>Submit</button>
            <button className={styles.submitBtn} onClick={this.handlePaid}>Paid</button>
            <button className={styles.submitHold} onClick={this.handlehold}>Hold</button>
