    ...
    try {
      ...
      if (Number(form.TotalProjectAmount) <= 200000)
        payload = {
          ...
          TotalProjectAmount: form.TotalProjectAmount?.toString() || null,
          ApplicableTaxes: form.ApplicableTaxes?.toString() || 0,
        ...
        payload = {
          ...
          ProjectReffNo: form.ProjectReffNo || "",
          ProjectDescription: form.ProjectDescription || "",
          TotalProjectAmount: form.TotalProjectAmount?.toString() || "0",
          ApplicableTaxes: form.ApplicableTaxes?.toString() || "0",
          Vendor1: form.Vendor1 || "",
          Vendor2: form.Vendor2 || "",
          Vendor3: form.Vendor3 || "",
