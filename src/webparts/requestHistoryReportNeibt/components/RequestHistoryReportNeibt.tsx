...
import styles from './RequestHistoryReportNeibt.module.scss';
import { IRequestHistoryReportNeibtProps } from './IRequestHistoryReportNeibtProps';
...
const RequestHistoryReportNeibt: React.FC<IRequestHistoryReportNeibtProps> = (props) => {
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h2>Request History Report
            <span>Digiflow / NEIBT / Request History Report</span>
          </h2>
        </div>
...
export default RequestHistoryReportNeibt;