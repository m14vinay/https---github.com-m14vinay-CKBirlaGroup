...
import styles from './FinanceReportExpense.module.scss';
import { IFinanceReportExpenseProps } from './IFinanceReportExpenseProps';
...
const FinanceReportExpense: React.FC<IFinanceReportExpenseProps> = (props) => {
    ...
    <section>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h2>Finance Report
            <span>Digiflow / Expense / Finance Report</span>
          </h2>
        </div>
...
export default FinanceReportExpense;