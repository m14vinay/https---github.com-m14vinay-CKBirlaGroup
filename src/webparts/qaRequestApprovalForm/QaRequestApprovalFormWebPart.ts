...
export default class QaRequestApprovalFormWebPart extends BaseClientSideWebPart<IQaRequestApprovalFormWebPartProps> {
  ...
  public render(): void {
    ...
    const element: React.ReactElement<IQaRequestApprovalFormProps> = React.createElement(
      QaRequestApprovalForm,
      {
