                          ...
                          <div className={styles["accordion-body"]}>
                            ...
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='YearofEstablishment' value={form.YearofEstablishment} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                            ...
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='GST' value={form.GST} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                            ...
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='Tin' value={form.Tin} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Central Sales Tax No.</label>
                                <input style={{ width: '50%' }} name='CentralSalesTaxNo' value={form.CentralSalesTaxNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Service Tax Regd No.</label>
                                <input style={{ width: '50%' }} name='ServiceTaxRegNo' value={form.ServiceTaxRegNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Nature of Services/Goods</label>
                                <input style={{ width: '50%' }} name='NatureofService' value={form.NatureofService} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>MSME Registration No.</label>
                                <input style={{ width: '50%' }} name='MSMERegistrationNo' value={form.MSMERegistrationNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>ESIC No.</label>
                                <input style={{ width: '50%' }} name='ESICNo' value={form.ESICNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Excise Registration No.</label>
                                <input style={{ width: '50%' }} name='ExciseRegisterNo' value={form.ExciseRegisterNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Work Contract Tax No</label>
                                <input style={{ width: '50%' }} name='WorkContractTaxNo' value={form.WorkContractTaxNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='FullAddress' value={form.FullAddress} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Telephone No.</label>
                                <input style={{ width: '50%' }} name='TelephoneNo' value={form.TelephoneNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Fax No.</label>
                                <input style={{ width: '50%' }} name='FaxNo' value={form.FaxNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Email ID</label>
                                <input style={{ width: '50%' }} name='EmailId' value={form.EmailId} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Contacted Person</label>
                                <input style={{ width: '50%' }} name='ContactPerson' value={form.ContactPerson} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='RegFullAddress' value={form.RegFullAddress} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Registered Telephone No.</label>
                                <input style={{ width: '50%' }} name='RegTelephoneNo' value={form.RegTelephoneNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Registered Fax No.</label>
                                <input style={{ width: '50%' }} name='RegFaxNo' value={form.RegFaxNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Registered Email ID</label>
                                <input style={{ width: '50%' }} name='RegEmailId' value={form.RegEmailId} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Registered Contacted Person</label>
                                <input style={{ width: '50%' }} name='RegContactPerson' value={form.RegContactPerson} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='ConstitutionofOrganization' value={form.ConstitutionofOrganization} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='Manufacturer' value={form.Manufacturer} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Authorized Agent</label>
                                <input style={{ width: '50%' }} name='AuthorizedAgent' value={form.AuthorizedAgent} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Trader</label>
                                <input style={{ width: '50%' }} name='Trader' value={form.Trader} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Consulting</label>
                                <input style={{ width: '50%' }} name='ConsultingCompany' value={form.ConsultingCompany} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Other(Specify)</label>
                                <input style={{ width: '50%' }} name='Other' value={form.Other} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='Name' value={form.Name} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Address</label>
                                <input style={{ width: '50%' }} name='Address' value={form.Address} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Contact No.</label>
                                <input style={{ width: '50%' }} name='ContactNo' value={form.ContactNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='Details' value={form.Details} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                ...
                                <input style={{ width: '50%' }} name='BankName' value={form.BankName} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Branch Address</label>
                                <input style={{ width: '50%' }} name='BankAddress' value={form.BankAddress} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Name as appearing in account</label>
                                <input style={{ width: '50%' }} name='NameinBankAccount' value={form.NameinBankAccount} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Bank Account No.</label>
                                <input style={{ width: '50%' }} name='BankAccountNo' value={form.BankAccountNo} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles["formGroup"]}>
                                <label style={{ width: '50%' }}>Bank IFSC/MICR code</label>
                                <input style={{ width: '50%' }} name='BankIFSCMICRCode' value={form.BankIFSCMICRCode} onChange={handleChange} className='form-control' type='text' />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className={styles["accordion-body"]}>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                ...
                                <input style={{ width: '50%' }} name="filesDeedManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                <label style={{ width: '50%' }}>MSME Registration Certificate<span className={styles.required}>*</span></label>
                                <input style={{ width: '50%' }} name="filesMSMEManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                <label style={{ width: '50%' }}>Factory License</label>
                                <input style={{ width: '50%' }} name="filesLicenseManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                <label style={{ width: '50%' }}>ISO 9001 Certificates</label>
                                <input style={{ width: '50%' }} name="filesISOManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                <label style={{ width: '50%' }}>Bank IFSC/MICR code<span className={styles.required}>*</span></label>
                                <input style={{ width: '50%' }} name="filesIFSCManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                            ...
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                ...
                                <input style={{ width: '50%' }} name="filesServiceManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                            ...
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                ...
                                <input style={{ width: '50%' }} name="filesTelephonManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                <label style={{ width: '50%' }}>Name and Address of All Partners/ Directors<span className={styles.required}>*</span></label>
                                <input style={{ width: '50%' }} name="filesNameManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                <label style={{ width: '50%' }}>Cancelled cheque<span className={styles.required}>*</span></label>
                                <input style={{ width: '50%' }} name="filesCancelManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                ...
                                <input style={{ width: '50%' }} name="filesRegCertManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                            <div className={styles['col-md-12']}>
                              <div className={styles.formGroup}>
                                ...
                                <input style={{ width: '50%' }} name="filesOtherManual" type="file" multiple onChange={handleFileChange} />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className={styles["accordion-item"]}>
                      <div className={styles['col-md-12']}>
                        <div className={styles.formGroup}>
                          ...
                          <input style={{ width: '50%' }} name="UploadExcelFile" accept=".xlsx, .xls" type="file" multiple onChange={handleExcelFileChange} />
                        </div>
                      </div>
                      <div className={styles['col-md-12']}>
                      ...
                      <div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Partnership Deed or Memorandum of Article of Association<span className={styles.required}>*</span></label>
                            <input style={{ width: '50%' }} name="filesDeedExcel" type="file" multiple onChange={(e) => handleFileExChange(e, "filesDeedExcel")} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>MSME Registration Certificate<span className={styles.required}>*</span></label>
                            <input style={{ width: '50%' }} name="filesMSMEExcel" type="file" multiple onChange={(e) => handleFileExChange(e, "filesMSMEExcel")} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Factory License</label>
                            <input style={{ width: '50%' }} name="filesLicenseExcel" type="file" multiple onChange={(e) => handleFileExChange(e, "filesLicenseExcel")} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>ISO 9001 Certificates</label>
                            <input style={{ width: '50%' }} name="filesISOExcel" type="file" multiple onChange={handleFileChange} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Bank IFSC/MICR code<span className={styles.required}>*</span></label>
                            <input style={{ width: '50%' }} name="filesIFSCExcel" type="file" multiple onChange={(e) => handleFileExChange(e, "filesIFSCExcel")} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                        ...
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Service Tax Registration</label>
                            <input style={{ width: '50%' }} name="filesServiceExcel" type="file" multiple onChange={handleFileChange} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                        ...
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Telephone and Electricity Bill</label>
                            <input style={{ width: '50%' }} name="filesTelephoneExcel" type="file" multiple onChange={handleFileChange} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Name and Address of All Partners/ Directors<span className={styles.required}>*</span></label>
                            <input style={{ width: '50%' }} name="filesNameExcel" type="file" multiple onChange={(e) => handleFileExChange(e, "filesNameExcel")} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                        ...
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Registration Certificate with any other authority (if required)<span className={styles.required}>*</span></label>
                            <input style={{ width: '50%' }} name="filesRegCerExcel" type="file" multiple onChange={(e) => handleFileExChange(e, "filesRegCerExcel")} />
                          </div>
                        </div>
                        <div className={styles['col-md-12']}>
                          <div className={styles.formGroup}>
                            <label style={{ width: '50%' }}>Any other document (as per the nature of the transaction/vendor)<span className={styles.required}>*</span></label>
                            <input style={{ width: '50%' }} name="filesOtherExcel" type="file" multiple onChange={(e) => handleFileExChange(e, "filesOtherExcel")} />
                          </div>
                        </div>
                      </div>
                    </div>
