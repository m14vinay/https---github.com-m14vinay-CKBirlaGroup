...
export interface IVendorRegistrationManuallyWebPartProps {
  description: string;
}

export default class VendorRegistrationManuallyWebPart extends BaseClientSideWebPart<IVendorRegistrationManuallyWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IVendorRegistrationManuallyProps> = React.createElement(
      VendorRegistrationManually,
      {
