...
import styles from './FinanceReportNeibt.module.scss';
import { IFinanceReportNeibtProps } from './IFinanceReportNeibtProps';
...
const FinanceReportNeibt: React.FC<IFinanceReportNeibtProps> = (props) => {
    ...
    <section>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h2>Finance Report
            <span>Digiflow / NEIBT / Finance Report</span>
          </h2>
        </div>
...
export default FinanceReportNeibt;