...
export default class QuotationRequestApprovalNeiBt extends React.Component<IQuotationRequestApprovalNeiBtProps> {
  public render(): React.ReactElement<IQuotationRequestApprovalNeiBtProps> {
    ...
    return (
      <section className={`${styles.quotationRequestApprovalNeiBt} ${hasTeamsContext ? styles.teams : ''}`}>
