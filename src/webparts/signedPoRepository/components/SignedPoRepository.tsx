...
import styles from './SignedPoRepository.module.scss';
import { ISignedPoRepositoryProps } from './ISignedPoRepositoryProps';
...
const SignedPoRepository: React.FC<ISignedPoRepositoryProps> = (props) => {
    ...
    <section>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h2>Signed PO Repository
            <span>Digiflow / Repository / Signed PO Repository</span>
          </h2>
        </div>
        <div className="p-2">
...
export default SignedPoRepository;