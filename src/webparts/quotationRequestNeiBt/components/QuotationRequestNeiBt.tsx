...
export default class QuotationRequestNeiBt extends React.Component<IQuotationRequestNeiBtProps> {
  public render(): React.ReactElement<IQuotationRequestNeiBtProps> {
    ...
    return (
      <section className={`${styles.quotationRequestNeiBt} ${hasTeamsContext ? styles.teams : ''}`}>
