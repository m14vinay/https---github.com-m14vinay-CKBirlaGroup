...
import styles from './SummaryReportExpense.module.scss';
import { ISummaryReportExpenseProps } from './ISummaryReportExpenseProps';
...
const SummaryReportExpense: React.FC<ISummaryReportExpenseProps> = (props) => {
    ...
    <section>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h2>Summary Report
            <span>Digiflow / Expense / Summary Report</span>
          </h2>
        </div>
...
export default SummaryReportExpense;