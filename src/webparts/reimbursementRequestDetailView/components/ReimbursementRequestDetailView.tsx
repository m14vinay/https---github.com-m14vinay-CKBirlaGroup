...
export default class ReimbursementRequestDetailView extends React.Component<IReimbursementRequestDetailViewProps> {
  public render(): React.ReactElement<IReimbursementRequestDetailViewProps> {
    ...
    return (
      <section className={`${styles.reimbursementRequestDetailView} ${hasTeamsContext ? styles.teams : ''}`}>
