...
export default class BillProcessingDetailView extends React.Component<IBillProcessingDetailViewProps> {
  public render(): React.ReactElement<IBillProcessingDetailViewProps> {
    ...
    return (
      <section className={`${styles.billProcessingDetailView} ${hasTeamsContext ? styles.teams : ''}`}>
